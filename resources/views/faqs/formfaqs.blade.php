            ...
            <div class="flex flex-wrap lg:justify-between -mx-4">
                <div class="w-full lg:w-1/2 xl:w-6/12 px-4">
                  ...
                  ">
                        ...
                        <p class="text-base text-body-color leading-relaxed mb-9">
                            Ingresa tu consulta dentro el campo consulta a la brevedad un equipo
                            de Stock Inteligente te respondera!
                        </p>
                        <span>
                ...
                <div class="w-full lg:w-1/2 xl:w-5/12 px-4">
                    <div class="bg-white relative rounded-lg p-8 sm:p-12 shadow-lg">
                        <form action="{{ route('faqs.process') }}" method="POST">
                            @csrf
                            @method('POST')
                            <div class="mb-6">
                            ...
                            <div class="mb-6">
                                <input name ="email" type="email" placeholder="Tu Email" value="{{ old('email') }}"
                                    class="
                        w-full
                        rounded
                        py-3
                        ...
                        " />
                            ...
                            <div class="mb-6">
                                <textarea name="question" rows="6" placeholder="Tu consulta" value="{{ old('question') }}"
                                    class="
                        w-full
                        rounded
                        py-3
